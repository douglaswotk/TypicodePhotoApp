package gguuimaraes.com.br.typicodephotoapp.activities;
...
import gguuimaraes.com.br.typicodephotoapp.R;
import gguuimaraes.com.br.typicodephotoapp.adapters.PhotoAdapter;
import gguuimaraes.com.br.typicodephotoapp.bootstrap.APIClient;
import gguuimaraes.com.br.typicodephotoapp.models.Photo;
import gguuimaraes.com.br.typicodephotoapp.resources.PhotoResource;
...
public class PhotoActivity extends AppCompatActivity implements PhotoAdapter.ItemClickListener {
    ...
    public void deletar(View view) {
        if (edicao && photo.getId() != null) {
            ...
            Toast.makeText(this, "Select a photo to kill him!", Toast.LENGTH_SHORT).show();
    }
}
